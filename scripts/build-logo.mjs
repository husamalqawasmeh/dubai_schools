...
/* ---------- geometry ---------- */
const CX = 84;          // lens centre
const CY = 82;
const R_OUTER = 80;     // outer edge of the ring
const RING = 9;         // ring thickness
 ...
 * the bubbles read as floating, which is the reference image's whole character,
 * and above about 65% they read as a crowd.
 */
...
const inner = `  <defs>
  ...
  <path d="M148 146 L178 176" stroke="#3c2a33" stroke-width="18" stroke-linecap="round" fill="none"/>
  <path d="M136 134 L152 150" stroke="#9fb4a6" stroke-width="16" stroke-linecap="round" fill="none"/>
...
${placed.map(bubble).join("\n")}
  ...
  <path d="M38 58a52 34 0 0 1 52-27" stroke="#ffffff" stroke-width="7"
        stroke-linecap="round" fill="none" opacity=".55"/>`;

const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="200" height="200" role="img" aria-label="Dubai Schools">
  <!--
